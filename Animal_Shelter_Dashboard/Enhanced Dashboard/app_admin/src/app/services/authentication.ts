...
export class Authentication {
  ...
  public getToken(): string {
    let out: any;
    out = this.storage.getItem('aac-token');
  ...
  public saveToken(token: string): void {
    this.storage.setItem('aac-token', token);
  }
  // Logout of our application and remove the JWT from Storage
  public logout(): void {
    this.storage.removeItem('aac-token');
  }
  ...
  // Login method that leverages the login method in animalDataService
